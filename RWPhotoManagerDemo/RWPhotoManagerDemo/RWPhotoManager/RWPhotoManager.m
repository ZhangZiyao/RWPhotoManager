...
@interface RWPhotoManager ()<LGPhotoPickerBrowserViewControllerDataSource,LGPhotoPickerBrowserViewControllerDelegate>
...
{
    RWPhotoManager *objct = [[RWPhotoManager alloc] init];
